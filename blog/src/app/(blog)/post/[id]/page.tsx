    ...
    <div className="max-w-[800px] mx-auto flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2 ">
            <div className="w-7 h-7 relative">
              <Image
                ...
                fill
                placeholder="blur"
                blurDataURL={generatePlaceholder(28, 28)}
      ...
      <div className="w-[800px] h-[462px] relative">
        <Image
          ...
          fill
          placeholder="blur"
          blurDataURL={generatePlaceholder(800, 462)}
          priority
      ...
      <article>
        ...
        <div className="p-8 rounded-xl bg-light-200 dark:bg-dark-300 my-8">
          <Typography variant={TypoVariants.TexExtraLarge} className="italic">
